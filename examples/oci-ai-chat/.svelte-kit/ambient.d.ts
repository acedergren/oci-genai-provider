...
declare module '$env/static/private' {
  export const OCI_COMPARTMENT_ID: string;
  ...
  export const npm_config__acedergren_registry: string;
  ...
  export const OCI_CONFIG_PROFILE: string;
...
declare module '$env/dynamic/private' {
  export const env: {
    ...
    USER: string;
    npm_config__acedergren_registry: string;
