...
**Supported Models**:
- **Grok**: xai.grok-4-maverick, xai.grok-4-scout, xai.grok-3, xai.grok-3-mini
- **Llama**: meta.llama-3.3-70b-instruct, meta.llama-3.2-vision-90b-instruct, meta.llama-3.1-405b-instruct
- **Cohere**: cohere.command-r-plus, cohere.command-a, cohere.command-a-reasoning, cohere.command-a-vision
...
const grokModel = oci.model('xai.grok-4-maverick');
```
